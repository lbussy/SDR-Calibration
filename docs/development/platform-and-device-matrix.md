...
| Windows 11 Pro 25H2 Store MSIX on `ecm-mule` | x64 | Locally build-covered at `957fbeb`; 19/19 hardware-free tests passed | Exact unsigned MSIX audit, WACK pass, and same-host development-signed install, CLI alias, GUI launch/relaunch, uninstall, and cleanup passed for SHA-256 `1d9828710dcec5c93862e217606a92f53c1470b5abb412a23725ebc811b1edc1`; Store delivery, update, clean-host, and prior-version upgrade not qualified | Temporary locally trusted development signature only; Microsoft Store signing, certification, and public trust not observed | [0.1.1 WACK and lifecycle record](https://github.com/lbussy/SDR-Calibration/blob/main/evidence/windows-store/2026-08-17-0.1.1-wack-lifecycle/README.md) |
