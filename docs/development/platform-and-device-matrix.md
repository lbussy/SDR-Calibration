...
| Windows 11 Pro 25H2 Store MSIX on `ecm-mule` | x64 | Locally build-covered at `99d96a6`; 19/19 hardware-free tests passed | Exact unsigned MSIX audit and same-host development-signed install, CLI alias, GUI launch/relaunch, uninstall, and cleanup passed for SHA-256 `de28c7d9c11c1fcf95e70ffc80a5147c6dfd5f26e93c8f6138906a6f6ba95f85`; Store delivery, update, clean-host, and prior-version upgrade not qualified | Temporary locally trusted development signature only; Microsoft Store signing, certification, and public trust not observed | [Native MSIX record](https://github.com/lbussy/SDR-Calibration/blob/main/evidence/windows-store/2026-08-17-native-msix-qualification/README.md) |
