...
| --- | --- | --- | --- | --- | --- |
| macOS 26.5.2 current DMG | arm64 | Locally build-covered at `5eb3670` with Apple clang 21.0.0, CMake 4.4.2, and Qt 6.11.1; 16/16 hardware-free tests passed | Exact DMG payload/runtime and license disposition passed; same-host install, first launch, normal relaunch, CLI help, removal, and restoration lifecycle passed; SHA-256 `94a831d4549b92edd85222c55e0cd64395dbe8acfd1f4bd5c57351f15bf80ad4`; clean-host install and prior-version upgrade not qualified | Developer ID signed with hardened runtime; application and DMG notarized, stapled, and accepted by Gatekeeper | [Exact-host macOS evidence](https://github.com/lbussy/SDR-Calibration/blob/main/evidence/macos-arm64/2026-08-17-same-host-5eb3670/README.md) |
