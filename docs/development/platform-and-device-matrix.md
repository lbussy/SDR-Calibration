...
| Windows Store MSIX | x64 | Source packaging contract implemented; native Windows build not yet run for this artifact | Not built, uploaded, certified, installed, updated, or lifecycle-qualified | Microsoft Store signing not observed; public trust remains open | [Store MSIX guide](windows-store-msix.md) |
