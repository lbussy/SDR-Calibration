...
| --- | --- | --- | --- | --- | --- |
| macOS 26.5.2 Phase 14.4 DMG | arm64 | Locally build-covered at `6bba593` with Apple clang 21.0.0, CMake 4.4.2, and Qt 6.11.1 | Exact DMG payload/runtime and Qt license disposition passed; SHA-256 `5f067b77b23d21b824701a13633d306e2fd2ea7728147a586a94ac400d5b0f26`; clean-host install not qualified | Developer ID signed with hardened runtime; application and DMG notarized, stapled, and accepted by Gatekeeper | Local Phase 14.4 evidence under `build/macos-official-release/macos-package/evidence` |
