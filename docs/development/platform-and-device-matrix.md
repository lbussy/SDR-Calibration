...
| Windows Store MSIX | x64 | Source packaging contract implemented and exact Store identity reserved; native Windows build not yet run for this artifact | Not built, uploaded, certified, installed, updated, or lifecycle-qualified | Microsoft Store signing not observed; public trust remains open | [Store reservation record](https://github.com/lbussy/SDR-Calibration/blob/main/evidence/windows-store/2026-08-17-product-reservation/README.md) |
